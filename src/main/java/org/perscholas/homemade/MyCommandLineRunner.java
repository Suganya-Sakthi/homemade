...
public class MyCommandLineRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
       ...
       imageService.init();
        ...
        Product p1=new Product("Pasta","Italian",10.00,LocalDate.of(2023,04,23),chef);
        Product p2=new Product("Chicken Burger","American",20.00, LocalDate.of(2023,04,23),chef);
        Product p3=new Product("Chicken Sandwich","American",15.00,LocalDate.of(2023,04,26),c3);
        Product p4=new Product("Samosa","Indian",10.00,LocalDate.of(2023,04,23),c4);
        Product p5=new Product("Salad","American",10.00,LocalDate.of(2023,04,27),c1);
